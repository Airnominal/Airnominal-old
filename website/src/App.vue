...
@Component({
  components: {
    ViewNavigationDesktop: () => import('@/components/navigation/ViewNavigationDesktop.vue'),
    ViewNavigationMobile: () => import('@/components/navigation/ViewNavigationMobile.vue')
  }
})
